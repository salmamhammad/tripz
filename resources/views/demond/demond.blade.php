                        ...
                        <div id="flights" class="tab-pane in active">
                            <form action="{{ url('/demond') }}" method="POST">
                                ...
                                <div class="row">
                                   ...
                                   array_push($arraycountry,$country->name);
                                                }
                                    ...
                                    <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                                        <div class="form-group right-icon">
                                            <select class="form-control visass" disabled name="visass"  id="visass" required> 
                                                <option selected>   Types de visas *</option>
                                                @foreach ($countries as $country)
                                                @foreach ($visas as $visa)
                                                @if($country->visaid==$visa->id)
                                                <option style="display: none"  class="{{ $country->name }} visacountry" value="{{ $visa->id }}">{{ $visa->type }} - price : {{ $country->price }} $</option>
                                                 @endif
                                                @endforeach
                                                @endforeach
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                                        <div class="form-group right-icon">
                                            <input type="number" name="numberfamily" class="form-control" placeholder="nombre de personne *" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                                        <div class="form-group right-icon">
                                            <input type="text" onfocus="(this.type='date')" name="datearrive" class="form-control" required placeholder="Date d'arrivée * " >
                                    ...
                                    <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                                        <div class="form-group right-icon">
                                            <select class="form-control" name="docvoyager" required>
