                        ...
                        <div class="grid-block main-block h-grid-block">
                            <div class="main-img h-grid-img">
                             ...
                             <div class="block-info h-grid-info">
                                 ...
                                 <h3 class="block-title"><a href="{{ route('travelemond',['id'=>$travel->id]) }}">{{ $travel->name }}</a></h3>
                                <p class="block-minor">Lieu : {{ $travel->location }}</p>
                                <p>{{ $travel->discrip }} </p>
                                <div class="grid-btn">
                                    <a href="{{ route('travelemond',['id'=>$travel->id]) }}" class="btn btn-orange btn-block btn-lg">Voir plus</a>
                                </div><!-- end grid-btn -->
                             </div><!-- end h-grid-info -->
