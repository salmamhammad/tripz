...
@section('content')
    <div class="page-content">
        ...
        @if (Auth::user()->role_id==3||Auth::user()->role_id==5||Auth::user()->role_id==1)
        <div class="panel panel-bordered ">
           ...
           @endforeach
            ...
            <td>  <a href="{{route('alldata',['id'=>$user->id])}}"  class=" btn btn-success btn-add-new " href="" style="background: #cc2eaa;">
                <span>Montrer </span>
               </a></td>
                        </tr> 
                        @endif   
