    ...
    <div class="modal" tabindex="-1" role="dialog" id="AccepterModal">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
          <a href="{{ url('admin/acceptedmond?id='.$dataTypeContent->id.'&type=Visademond') }}">    <button type="button" class="btn btn-primary">Continuez</button></a>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="RejetModal">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
          <a href="{{ url('admin/rejetdmond?id='.$dataTypeContent->id.'&type=Visademond') }}">    <button type="button" class="btn btn-primary">Continuez</button></a>
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
            </div>
          </div>
        </div>
      ...
      <div class="modal" tabindex="-1" role="dialog" id="TerminaeModal">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
          <a href="{{ url('admin/terminedmond?id='.$dataTypeContent->id.'&type=Visademond') }}">    <button type="button" class="btn btn-primary">Continuez</button></a>
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
            </div>
          </div>
        </div>
